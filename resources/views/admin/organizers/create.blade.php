                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.organisor')}}">Organizers </a>
                                </li>
                                <li class="breadcrumb-item active">Add Organisor
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> Add Organisor </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.organisor.store')}}"
                                              method="POST"
                                              enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
                                                <label> Logo Organisor </label>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> Data Organisor </h4>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="category_id" class="select form-control">
                                                                <option label="Please choose the department ">
