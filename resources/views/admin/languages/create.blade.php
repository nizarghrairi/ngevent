                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> Adding a languagee </h4>
                                ...
                                {{--@includes('admin.includes.alerts.success')
                                @includes('admin.includes.alerts.errors')--}}
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.languages.store')}}" method="POST"
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-home"></i> Données linguistiques </h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="" id="name"
                                                                   class="form-control"
                                                                   placeholder="اEntrez l'abréviation de la langue  "
                                                                   name="abbr">
                                                            @error('abbr')
                                                            <span class="text-danger">{{$message}} </span>
                                                            @enderror
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="direction" class="select2 form-control">
                                                                <optgroup label="Veuillez choisir la direction de la langue ">
