                ...
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="">Principale</a>
                                </li>
                                <li class="breadcrumb-item"><a href=""> Les sections principales </a>
                                </li>
                                <li class="breadcrumb-item active"> - Modification{{$mainCategory -> name}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> Modify a major section </h4>
                                    ...
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img
                                                        ...
                                                        class="rounded-circle  height-150" alt="Section image  ">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> Department data </h4>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> Department Name
                                                    ...
                                                    <div class="col-md-6 hidden">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> Abbreviation
