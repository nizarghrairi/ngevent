                    ...
                    if (full.length > actual.length) {
                        for (i = 0, len = full.length; i < len; i++) {
                            ...
                            if (CSSLint.Util.indexOf(actual, item) === -1) {
                                ...
                                reporter.report("The property " + item + " is compatible with " + propertiesSpecified + " and should be includes as well.", value.actualNodes[0].line, value.actualNodes[0].col, rule);
                            }
                        }
